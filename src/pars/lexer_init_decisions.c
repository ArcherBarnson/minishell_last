...
int	ft_init_lex_decision_3(t_lex *lex)
{
	...
	lex->decision[SPL_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_ERR_SPL};
	return (0);
}
...
int	ft_init_lex_decision_4(t_lex *lex)
{
	...
	lex->decision[DBL_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_ERR_DBL};
	return (0);
}
