...
/*   Updated: 2022/10/12 18:21:45 by mbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_init_lex_decision_1(t_lex *lex)
{
	...
	lex->decision[NEW_LEX_RD_MD][STD_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};
	lex->decision[NEW_LEX_RD_MD][SPL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, SPL_LEX_RD_MD, TOK_WORD};
	lex->decision[NEW_LEX_RD_MD][DBL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, DBL_LEX_RD_MD, TOK_WORD};
	lex->decision[NEW_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, PIPE_LEX_RD_MD, TOK_PIPE};
	lex->decision[NEW_LEX_RD_MD][AMP_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, AMP_LEX_RD_MD, TOK_AMP};
	lex->decision[NEW_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, LT_LEX_RD_MD, TOK_LSS};
	lex->decision[NEW_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, GT_LEX_RD_MD, TOK_GRT};
	lex->decision[NEW_LEX_RD_MD][DOL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};
	lex->decision[NEW_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_END, LEX_SKIP, NEW_LEX_RD_MD, TOK_WORD};
	return (0);
}
...
int	ft_init_lex_decision_3(t_lex *lex)
{
	...
	lex->decision[SPL_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SPL_ERR_LEX_RD_MD, TOK_WORD};
	return (0);
}
...
int	ft_init_lex_decision_4(t_lex *lex)
{
	...
	lex->decision[DBL_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, DBL_ERR_LEX_RD_MD, TOK_ERR_DBL};
	return (0);
}
...
int	ft_init_lex_decision_5(t_lex *lex)
{
	...
	lex->decision[PIPE_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_WORD};
	lex->decision[PIPE_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[PIPE_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[PIPE_LEX_RD_MD][DOL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};
	lex->decision[PIPE_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
	return (0);
}
...
int	ft_init_lex_decision_6(t_lex *lex)
{
	...
	lex->decision[LT_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[LT_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_KEEP, LEX_TAKE, HDOC_LEX_RD_MD, TOK_HDOC};
	lex->decision[LT_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_WORD};
...
int	ft_init_lex_decision_7(t_lex *lex)
{
	...
	lex->decision[GT_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[GT_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
...
int	ft_init_lex_decision_8(t_lex *lex)
{
	...
	lex->decision[HDOC_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[HDOC_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[HDOC_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
...
int	ft_init_lex_decision_9(t_lex *lex)
{
	...
	lex->decision[GGRT_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[GGRT_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_NONE, LEX_ERR, SYN_ERR_LEX_RD_MD, TOK_NEW};
