...
/*   Updated: 2022/10/12 05:29:16 by mbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_init_pars_decision_1(t_pars *pars)
{
	...
	pars->pars_decision[NEW_PARS_RD_MD][TOK_PIPE] = (t_pars_proc){PARS_NONE, PARS_ERR, SYN_ERR_PARS_RD_MD};
...
int	ft_init_pars_decision_2(t_pars *pars)
{
	...
	pars->pars_decision[STD_PARS_RD_MD][TOK_PIPE] = (t_pars_proc){PARS_SKIP, PARS_KEEP, NEW_PARS_RD_MD};
...
int	ft_init_pars_decision_3(t_pars *pars)
{
	...
	pars->pars_decision[LT_PARS_RD_MD][TOK_PIPE] = (t_pars_proc){PARS_NONE, PARS_ERR, SYN_ERR_PARS_RD_MD};
...
int	ft_init_pars_decision_4(t_pars *pars)
{
	...
	pars->pars_decision[GT_PARS_RD_MD][TOK_PIPE] = (t_pars_proc){PARS_NONE, PARS_ERR, SYN_ERR_PARS_RD_MD};
...
int	ft_init_pars_decision_5(t_pars *pars)
{
	...
	pars->pars_decision[HDOC_PARS_RD_MD][TOK_PIPE] = (t_pars_proc){PARS_NONE, PARS_ERR, SYN_ERR_PARS_RD_MD};
...
int	ft_init_pars_decision_6(t_pars *pars)
{
	...
	pars->pars_decision[GGRT_PARS_RD_MD][TOK_PIPE] = (t_pars_proc){PARS_NONE, PARS_ERR, SYN_ERR_PARS_RD_MD};
